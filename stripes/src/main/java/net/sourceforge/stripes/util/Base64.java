 ...
 * compatibility), and encoding using the URL-safe and Ordered dialects.</p>
 *
 * <p>
 * The constants defined in Base64 can be OR-ed together to combine options, so
 * you might make a call like this:</p>
 *
 ...
 * calls that you were making to support the new options format (<code>int</code>s
...
public class Base64 {
     ...
     * error, the method will return <code>null</code>. The object is not
     ...
     * <code>java.io.InputStream</code>, given in the constructor, and encode/decode
