...
public class UrlBuilder {
   ...
   public UrlBuilder( Locale locale, Class<? extends ActionBean> beanType, boolean isForPage ) {
      ...
      if ( configuration != null ) {
         _baseUrl = configuration.getActionResolver().getUrlBinding(beanType);
      } else {
   ...
   public UrlBuilder addParameter( String name, Object... values ) {
      ...
      for ( Object v : values ) {
         ...
         if ( v instanceof Collection<?> ) {
            ...
            _parameters.add(new Parameter(name, v));
            _url = null;
         }
      }
   ...
   public String getEvent() {
      return (String)(_event == null ? null : _event.value);
   }
    ...
    * pages and '&' otherwise.
    */
   public String getParameterSeparator() { return _parameterSeparator; }
   ...
   public UrlBuilder setEvent( String event ) {
       _event = new Parameter(UrlBindingParameter.PARAMETER_NAME_EVENT, event);
      _url = null;
      return this;
   }
   ...
   public String toString() {
      ...
      if ( _anchor != null && _anchor.length() > 0 ) {
         return _url + "#" + StringUtil.uriFragmentEncode(_anchor);
      } else {
         return _url;
      }
   }
   ...
   protected String build() {
      ...
      List<Parameter> parameters = new ArrayList<>(_parameters.size() + 1);
      if ( _event != null ) {
         parameters.add(_event);
      }
      ...
      buffer.append(getBaseURL(_baseUrl, parameters));
      ...
      for ( Parameter param : parameters ) {
         ...
         if ( param == _event ) {
            if ( param.value == null ) {
               ...
               param = new Parameter((String)_event.value, "");
            }
         }
   ...
   protected Formatter getFormatter( Object value ) {
      ...
      return factory.getFormatter(value.getClass(), _locale, null, null);
   }
   ...
   protected Map<String, ValidationMetadata> getValidationMetadata() {
      ...
      if ( configuration != null ) {
         ...
         try {
            beanType = configuration.getActionResolver().getActionBeanType(_baseUrl);
         }
         catch ( UrlBindingConflictException e ) {
            // This can be safely ignored
         }
