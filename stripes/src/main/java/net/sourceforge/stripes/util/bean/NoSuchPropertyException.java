...
/**
 * Exception indicating that an expression could not be evaluated against a bean
 * because the bean (or some sub-property of the bean) did not have a property
 * matching the name supplied in the expression.
 *
 * @author Tim Fennell
 * @since Stripes 1.4
 */
