 ...
 * Nested properties are fully supported. If a property is non-String and
 * implements {@link Comparable} then the {@code compareTo()} method is
 * delegated to. Otherwise the property is converted to a String and a
 * {@link Locale} aware {@link Collator} is used to to compare property
 * values.</p>
 *
 * @author Tim Fennell
 * @since Stripes 1.5
...
public class BeanComparator implements Comparator<Object> {
    ...
    /**
     * Constructs a BeanComparator for comparing beans based on the supplied set
     * of properties, using the default system Locale to collate Strings.
     *
    ...
    /**
     * Constructs a BeanComparator for comparing beans based on the supplied set
     * of properties, using the supplied Locale to collate Strings.
     *
    ...
    /**
     * <p>
     * Compares two JavaBeans for order. Returns a negative integer, zero, or a
     * positive integer as the first argument sorts earlier, equal to, or later
     * than the second.</p>
     *
     * <p>
     * Iterates through the properties supplied in the constructor comparing the
     * values of each property for the two beans. As soon as a property is found
     * that supplied a non-equal ordering, the ordering is returned. If all
     * properties are equal, will return 0.</p>
     *
     ...
     * properties, prevent them from being compared by this Comparator.
     */
