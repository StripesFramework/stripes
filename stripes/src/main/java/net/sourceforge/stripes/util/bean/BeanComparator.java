...
public class BeanComparator implements Comparator<Object> {
   ...
   * the default system Locale to collate Strings.
   *
  ...
  /**
   * Constructs a BeanComparator for comparing beans based on the supplied set of properties, using
   * the supplied Locale to collate Strings.
   *
  ...
  /**
   * Compares two JavaBeans for order. Returns a negative integer, zero, or a positive integer as
   * the first argument sorts earlier, equal to, or later than the second.
   *
   * <p>Iterates through the properties supplied in the constructor comparing the values of each
   * property for the two beans. As soon as a property is found that supplied a non-equal ordering,
   * the ordering is returned. If all properties are equal, will return 0.
   *
