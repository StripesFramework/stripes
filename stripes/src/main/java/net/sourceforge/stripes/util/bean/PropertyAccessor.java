...
/**
 * Interface which is implemented by classes capable of acting as accessors for
 * certain types of classes. Currently this is tied very tightly to the
 * {@link NodeType} enum. Each PropertyAccessor must be able to store and
 * retrieve values from the target type.
 *
 * @author Tim Fennell
 * @param <T>
 * @since Stripes 1.4
...
public interface PropertyAccessor<T> {
     ...
     *
     * @param evaluation provides access to the name and type of the desired
     * property as well as to prior and subsequent nodes in the expression
