 ...
 * {@literal <input type="text" name="foo" value="bar"/>}, which can dynamically
 * re-populate their value. Text tags may have only a single value, whose
 * default may be set using either the body of the tag, or using the value=""
 * attribute of the tag. At runtime the contents of the text field are
 * determined by looking for the first non-null value in the following list:</p>
 *
 * <ul>
...
public class InputTextTag extends InputTagSupport implements BodyTag {
    ...
    /**
     * Gets the maxlength value that is in effect for this tag, as determined by
     * checking {@link #getMaxlength()} and then the {@code maxlength} element
     * of the {@link Validate} annotation on the associated {@link ActionBean}
     * property.
     *
     * @return 
    ...
    /**
     * Determines which source is applicable for the value of the text field and
     * then writes out the tag.
     *
