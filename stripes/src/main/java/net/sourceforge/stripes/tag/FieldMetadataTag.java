...
/**
 * Field metadata tag for use with the Stripes framework. Exposes field properties via JavaScript to
...
public class FieldMetadataTag extends HtmlTagSupport implements BodyTag {
  ...
  private String getMetadata() {
    ...
    if (form != null) bean = form.getActionBean();
    ...
    ValidationMetadataProvider metadataProvider =
    ...
    if ((this.fields != null) && (!this.fields.trim().isEmpty()))
      ...
      log.error(
          "Fields attribute is required when field-metadata tag isn't inside of a Stripes form tag.");
      return null;
    }
    ...
    for (String field : fields) {
      ...
      if (fieldType.isPrimitive()
        ...
        fieldInfo
            .append("type:")
            .append(JavaScriptBuilder.quote(fqn ? fieldType.getName() : fieldType.getSimpleName()));
      }
      ...
      if (data != null) {
        ...
        if (data.on() != null) {
          ...
          while (it.hasNext()) {
            ...
            if (it.hasNext()) fieldInfo.append(",");
          }
          fieldInfo.append("]");
        }
        if (data.mask() != null)
          fieldInfo
              ...
              .append(")");
        if (data.minlength() != null) fieldInfo.append(",minlength:").append(data.minlength());
        if (data.maxlength() != null) fieldInfo.append(",maxlength:").append(data.maxlength());
        if (data.minvalue() != null) fieldInfo.append(",minvalue:").append(data.minvalue());
        if (data.maxvalue() != null) fieldInfo.append(",maxvalue:").append(data.maxvalue());
        ...
        if (label != null) fieldInfo.append(",label:").append(JavaScriptBuilder.quote(label));
  ...
  /**
   * Optional comma separated list of additional fields to expose. Any fields that have already been
   * added to the Stripes form tag will automatically be included.
   *
  ...
  /**
   * This is what is placed into the request attribute. It allows us to get the field metadata as
   * well as the form id.
   */
  public class Var {
    ...
    private Var(String fieldMetadata) {
      ...
      FormTag form = getForm();
      if (form != null) {
        if (form.getId() == null) form.setId("stripes-" + new Random().nextInt());
