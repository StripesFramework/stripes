...
/**
 * A very basic implementation of the Tag interface that is similar in manner to
 * the standard TagSupport class, but with less clutter.
 *
 * @author Tim Fennell
 */
public abstract class StripesTagSupport implements Tag {
    ...
    /**
     * A map that is used to store values of page context attributes before they
     * were replaced with other values for the body of the tag.
     */
    ...
    /**
     * Pushes new values for the attributes supplied into the page context,
     * preserving the old values so that they can be put back into page context
    ...
    /**
     * Attempts to restore page context attributes to their state prior to a
     * call to pushPageContextAttributes(). Attributes that had values prior to
     * the execution of this tag have their values restored. Attributes that did
     * not have values are removed from the page context.
     */
    ...
    /**
     * <p>
     * Locates the enclosing tag of the type supplied. If no enclosing tag of
    ...
    /**
     * Fetches a tag stack that is stored in the request. This tag stack is used
    ...
    /**
     * Helper method that takes an attribute which may be either a String class
     * name or a Class object and returns the Class representing the appropriate
     * ActionBean. If for any reason the Class cannot be determined, or it is
     * not an ActionBean, null will be returned instead.
     *
     * @param nameOrClass either the String FQN of an ActionBean class, or a
     * Class object
    ...
    /**
     * Similar to the {@link #getActionBeanType(Object)} method except that
     * instead of returning the Class of ActionBean it returns the URL Binding
     * of the ActionBean.
     *
     * @param nameOrClass either the String FQN of an ActionBean class, or a
     * Class object
