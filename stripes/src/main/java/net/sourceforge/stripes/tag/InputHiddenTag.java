 ...
 *
 * <ul>
 *   <li>for one or more values with the same name in the HttpServletRequest
 *   <li>for a field on the ActionBean with the same name (if a bean instance is present)
 *   <li>by collapsing the body content to a String, if a body is present
 *   <li>referring to the result of the EL expression contained in the value attribute of the tag.
 * </ul>
 *
...
public class InputHiddenTag extends InputTagSupport implements BodyTag {
  ...
  /**
   * Determines the value(s) that will be used for the tag and then proceeds to generate one or more
   * hidden fields to contain those values.
   *
