 ...
 *
 * <p>When {@link #toString()} is called, the component renderer will evaluate the body of any
...
public class LayoutComponentRenderer {
  ...
  public String getCurrentPage() {
    return (String)
        getPageContext().getRequest().getAttribute(StripesConstants.REQ_ATTR_INCLUDE_PATH);
  }
  ...
  public boolean write() throws ServletException, IOException {
    ...
    for (LayoutContext context = savedContext == null ? currentContext : savedContext.getPrevious();
        context != null;
      ...
      try {
        ...
        if (context.getComponent() == null) return true;
      } finally {
