 ...
 * over values from the request - even when the ActionBean returns null! Only if the ActionBean is
 * not present, or does not define an attribute with the name supplied to the tag will other
 * population sources be examined. When that happens, the strategy will check the value specified on
