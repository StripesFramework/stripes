...
/**
 * A collection of static functions that are included in the Stripes tag library. In most cases
 * these are not functions that are specific to Stripes, but simply functions that make doing web
 * development (especially with Java 5 constructs) easier.
 *
 * @author Tim Fennell
 * @since Stripes 1.1
 */
