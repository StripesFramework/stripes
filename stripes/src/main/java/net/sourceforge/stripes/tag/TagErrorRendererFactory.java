...
/**
 * Constructs and returns an instance of TagErrorRenderer to handle the error
 * output of a specific form input tag.
 *
 * @author Greg Hinkle
 */
public interface TagErrorRendererFactory extends ConfigurableComponent {
    ...
    /**
     * Returns a new instance of a TagErrorRenderer that is utilized by the
     * supplied tag.
     *
