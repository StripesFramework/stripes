...
/**
 * This tag accepts an object and formats it using an appropriate {@link Formatter}. The resulting
 * {@link String} can be assigned in the page, request, session or application scopes by using "var"
 * and "scope" or it can be written directly to the JSP output.
 *
 * @author Ben Gunter
 * @since Stripes 1.5
 */
  ...
  protected String format(Object value) {
    ...
    Formatter formatter =
        factory.getFormatter(
            ...
            this.formatType,
            this.formatPattern);
    if (formatter == null) return String.valueOf(value);
