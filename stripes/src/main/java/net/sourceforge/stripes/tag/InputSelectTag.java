...
public class InputSelectTag extends InputTagSupport implements BodyTag {
   ...
   private Object _selectedValueOrValues;
   ...
   public int doEndInputTag() throws JspException {
      writeCloseTag(getPageContext().getOut(), "select");
       _selectedValueOrValues = _value; // reset in case the tag is reused
      return EVAL_PAGE;
   }
   ...
   public int doStartInputTag() throws JspException {
      ...
      if ( override != null ) {
          _selectedValueOrValues = override;
      }
   ...
   public boolean isOptionSelected( Object optionValue, boolean selectedOnPage ) {
      if ( _selectedValueOrValues != null ) {
         return isItemSelected(optionValue, _selectedValueOrValues);
      } else {
