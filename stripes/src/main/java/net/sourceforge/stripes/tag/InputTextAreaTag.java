 ...
 * {@literal <textarea name="foo"> ... </textarea>}, which can dynamically
 * re-populate their value. Textareas may have only a single value, whose
 * default may be set using either the body of the textarea, or using the
 * value="" attribute of the tag. At runtime the contents of the textarea are
...
public class InputTextAreaTag extends InputTagSupport implements BodyTag {
    ...
    /**
     * Determines which source is applicable for the contents of the textarea
     * and then writes out the textarea tag including the body.
     *
