...
/**
 * <p>
 * A Stripes version of the {@literal <c:url/>} tag that adds some Stripes
 * specific parameters to the URL. Designed to generate URLs and either write
 * them into the page or set them into one of the JSP scopes.</p>
 *
 * <p>
 * Cooperates with the Stripes ParamTag to accept any number of parameters that
 * will be merged into the URL before rendering.</p>
 *
 * @author Tim Fennell
 * @since Stripes 1.4
 * @see ParamTag
...
public class UrlTag extends LinkTagSupport implements BodyTag {
    ...
    /**
     * Generates the URL and either writes it into the page or sets it in the
     * appropraite JSP scope.
     *
    ...
    /**
     * Gets the name of scope to store the scoped variable specified by 'var'
     * in.
     * @return 
     */
    ...
    /**
     * Sets the name of scope to store the scoped variable specified by 'var'
     * in.
     * @param scope
     */
