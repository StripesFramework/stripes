...
/**
 * A Stripes version of the {@literal <c:url/>} tag that adds some Stripes specific parameters to
 * the URL. Designed to generate URLs and either write them into the page or set them into one of
 * the JSP scopes.
 *
 * <p>Cooperates with the Stripes ParamTag to accept any number of parameters that will be merged
 * into the URL before rendering.
 *
 * @author Tim Fennell
 * @since Stripes 1.4
 * @see ParamTag
