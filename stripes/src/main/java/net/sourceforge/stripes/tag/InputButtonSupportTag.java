 ...
 *   <li>buttonName from the localized resource bundle
 *   <li>the trimmed body of the tag
...
public class InputButtonSupportTag extends InputTagSupport implements BodyTag {
  ...
  /**
   * Looks up the appropriate value to use for the submit button and then writes the tag out to the
   * page.
   *
