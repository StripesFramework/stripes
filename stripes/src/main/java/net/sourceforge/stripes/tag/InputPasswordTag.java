...
/**
 * Tag class that implements an input tag of type password. Defines one attribute in addition to
 * those provided by the HTML tag. If {@code repopulate} is set then the password tag will behave
 * just like the text tag, and will repopulate values on error and during wizard flows. If {@code
