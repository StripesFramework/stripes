...
/**
 * On the surface, allows a developer to define a layout using a custom tag - but is actually the
 * tag responsible for generating the output of the layout. A layout can have zero or more nested
 * components, as well as regular text and other custom tags nested within it.
 *
