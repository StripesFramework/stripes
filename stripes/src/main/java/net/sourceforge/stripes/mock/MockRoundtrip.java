...
/**
 * Mock object that attempts to make it easier to use the other Mock objects in this package to
 ...
 * actions it is recorded so that it can be reported and verified later. In the majority of cases it
 * should be sufficient to test ActionBeans in isolation and verify that they produced the expected
 * output data and/or forward/redirect. If your ActionBeans depend on being able to include other
 * resources before continuing, sorry - you're on your own!
 *
 * <p>An example usage of this class might look like:
 *
 * <pre>
...
public class MockRoundtrip {
  ...
  public MockRoundtrip(
      MockServletContext context, Class<? extends ActionBean> beanType, MockHttpSession session) {
