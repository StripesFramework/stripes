 ...
 * that the mock implementation does not support actually forwarding the
 * request, or including other resources. The methods are implemented to record
 * that a forward/include took place and then simply return.
 *
 * @author Tim Fennell
 * @since Stripes 1.1.1
 */
public class MockRequestDispatcher implements RequestDispatcher {
    ...
    /**
     * Constructs a request dispatcher, giving it a handle to the creating
     * request.
     * @param url
     */
