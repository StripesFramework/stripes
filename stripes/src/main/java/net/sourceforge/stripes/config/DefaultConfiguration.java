...
public class DefaultConfiguration implements Configuration {
      ...
      for (Map.Entry<LifecycleStage, Collection<Interceptor>> entry :
        ...
        for (Interceptor interceptor : interceptors) {
          ...
          if (classes.contains(clazz)) {
            log.warn(
                "Interceptor ", clazz, " is configured to run more than once for ", entry.getKey());
          } else {
            classes.add(clazz);
          }
        }
  ...
  /**
   * Returns an instance of {@link NameBasedActionResolver} unless a subclass has overridden the
   * default.
   *
  ...
  /**
   * Returns an instance of {@link DefaultActionBeanPropertyBinder} unless a subclass has overridden
   * the default.
   *
  ...
  /**
   * Returns the configured ActionBeanContextFactory. Unless a subclass has configured a custom one,
   * the instance will be a DefaultActionBeanContextFactory.
   *
