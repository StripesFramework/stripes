 ...
 * Allows a Configuration to instantiate and pass configuration to each of the
 * main components in a standardized manner. It is expected that all
 * ConfigurableComponents will have a public no-arg constructor.
 *
 * @author Tim Fennell
 */
