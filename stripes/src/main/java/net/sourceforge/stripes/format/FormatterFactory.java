...
/**
 * Interface for creating instances of formatter classes that are capable of formatting the types
 * specified into Strings.
 *
 * @see Formatter
 * @author Tim Fennell
 */
public interface FormatterFactory extends ConfigurableComponent {
  ...
  /**
   * Returns a configured formatter that meets the criteria specified. The formatter is ready for
   * use as soon as it is returned from this method.
   *
   ...
   * @return Formatter an instance of a Formatter, or null if no Formatter is available for the type
   *     specified
   */
   ...
   * not support adding formatters at runtime, then it must throw {@link
