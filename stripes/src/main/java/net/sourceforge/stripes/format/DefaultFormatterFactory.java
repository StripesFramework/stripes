...
public class DefaultFormatterFactory implements FormatterFactory {
  ...
  /**
   * Gets the (rather confusing) Map of Formatter objects. The Map uses the target class as the key
   * in the Map, and the Class object representing the Formatter as the value.
   *
  ...
  public Formatter<?> getFormatter(
      Class<?> clazz, Locale locale, String formatType, String formatPattern) {
  ...
  public Formatter<?> getInstance(
      Class<? extends Formatter<?>> clazz, String formatType, String formatPattern, Locale locale)
      throws Exception {
