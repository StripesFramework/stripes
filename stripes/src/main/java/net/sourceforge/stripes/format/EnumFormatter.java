...
/**
 * A simple formatter for Enum classes that always returns the value of Enum.name(). Intended really
 * only to enable the seamless usage of enums as values in hidden fields, radio buttons, checkboxes
 * etc. it is not intended that this will be used to format Enum values into text fields where a
...
public class EnumFormatter implements Formatter<Enum<?>> {
   ...
   * throwing a RuntimeException or subclass thereof.
   *
