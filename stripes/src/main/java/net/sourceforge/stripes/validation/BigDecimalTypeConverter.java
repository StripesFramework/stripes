...
/**
 * Type converter for converting localized strings into BigDecimal numbers without any loss of
...
public class BigDecimalTypeConverter extends NumberTypeConverterSupport
  ...
  public BigDecimal convert(
      String input, Class<? extends BigDecimal> targetType, Collection<ValidationError> errors) {
