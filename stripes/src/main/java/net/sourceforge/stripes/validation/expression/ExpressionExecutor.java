...
/**
 * Simple interface that specifies how Stripes will invoke expression based validation. Generally
 * used via the ExpressionValidator which will pick an appropriate implementation based on the
 * current environment.
 *
 * <p>Implementations should throw an exception from their default constructor if they are unable to
 * operate due to class versioning of availability issues.
 *
 * @author Tim Fennell
 * @since Stripes 1.5
 */
