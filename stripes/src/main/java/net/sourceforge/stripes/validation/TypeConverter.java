...
/**
 * Interface for all type converters in the validation system that provide facilities for converting
 * from String to a specific object type.
 *
 * @author Tim Fennell
 */
public interface TypeConverter<T> {
   ...
   * @param targetType the Class representing the type of the property to which the return value of
   *     the conversion will be assigned. In many cases this can be ignored as converters will
   *     return a single type more often than not.
