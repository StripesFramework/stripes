...
/**
 * Type converter for converting localized strings into BigInteger numbers without any loss of
 * magnitude or precision. Relies on NumberFormat.getInstance() returning a decimal format, and will
 * warn if that is not the case, as it will likely lead to loss of information.
 *
 * @author Tim Fennell
 * @since Stripes 1.1.2
 */
public class BigIntegerTypeConverter extends NumberTypeConverterSupport
  ...
  public BigInteger convert(
      String input, Class<? extends BigInteger> targetType, Collection<ValidationError> errors) {
