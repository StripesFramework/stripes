...
/**
 * Enumeration that describes the choices for when validation methods should be run. Allows
 * developers to choose between having their validation methods run always, only when there are no
 * errors, or to adopt the system default policy.
 *
 * @author Tim Fennell
 * @since Stripes 1.3
 */
public enum ValidationState {
  /**
   * Specifies that validations should be applied in all conditions without regard for whether there
   * are pre-existing validation errors.
   */
  ALWAYS,
