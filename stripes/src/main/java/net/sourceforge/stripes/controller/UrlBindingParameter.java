...
public class UrlBindingParameter {
  ...
  /**
   * Create a new {@link UrlBindingParameter} with the given name and value. The {@link
   * #defaultValue} will be null.
   *
   ...
   */
  public UrlBindingParameter(
      Class<? extends ActionBean> beanClass, String name, String value, String defaultValue) {
  ...
  /**
   * Make a copy of the given {@link UrlBindingParameter} except that the parameter's value will be
    ...
    if (PARAMETER_NAME_EVENT.equals(name)) {
      ...
      try {
        ...
        throw new StripesRuntimeException(
            "Caught an exception trying to get default handler for ActionBean '"
                + beanClass.getName()
                + "'. Make sure this ActionBean has a default handler.",
            e);
      }
