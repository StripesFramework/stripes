 ...
 * (com.oreilly.servlet) multipart parser implementation. This is the default
 * implementation in Stripes and is generally preferred as it is a) free for use
 * and b) has no other dependencies! However, commercial redistribution of the
 * COS library requires licensing from Jason Hunter, so this implementation may
 * not be applicable for commercial products that are distributed/sold (though
 * it is fine for commercial applications that are simply developed and hosted
 * by the company developing them).
 *
 * @author Tim Fennell
 * @since Stripes 1.4
 */
