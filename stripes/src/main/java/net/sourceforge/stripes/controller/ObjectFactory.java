...
/**
 * Used throughout Stripes to instantiate classes. The default implementation is {@link
 * DefaultObjectFactory}. You can specify an alternate implementation to use by setting the {@code
 * ObjectFactory.Class} initialization parameter for {@link StripesFilter} or by placing your
...
public interface ObjectFactory extends ConfigurableComponent {
   ...
   * instantiating classes by invoking a specific constructor. Typical usage might look like: <code>
   ...
   * @param constructorArgs The arguments to pass to the constructor. (See {@link
  ...
  /**
   * Provides a builder-style interface for instantiating objects by calling specific constructors.
   * Typical usage might look like: <code>
   * configuration.getObjectFactory().constructor(targetType, String.class).newInstance("FOO");
   * </code>
   *
   * @param <T> The type of the class to instantiate.
