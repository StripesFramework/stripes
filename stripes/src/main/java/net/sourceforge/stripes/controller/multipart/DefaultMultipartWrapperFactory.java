 ...
 * If no class name is configured, defaults to the {@link ServletMultipartWrapper}.
...
public class DefaultMultipartWrapperFactory implements MultipartWrapperFactory {
  ...
  public static final String[] BUNDLED_IMPLEMENTATIONS = {
      ServletMultipartWrapper.class.getCanonicalName()
  };
  ...
  public void init(Configuration config) throws Exception {
    ...
    File tempDir = (File) config.getServletContext().getAttribute("jakarta.servlet.context.tempdir");
    if (tempDir != null) {
