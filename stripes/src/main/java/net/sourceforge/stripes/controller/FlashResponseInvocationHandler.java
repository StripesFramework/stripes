...
/**
 * Used as the {@link java.lang.reflect.InvocationHandler} for a dynamic proxy
 * that replaces the {@link jakarta.servlet.http.HttpServletResponse} on {@link
 * net.sourceforge.stripes.action.ActionBeanContext}s in the flash scope after
 * the current request cycle has completed.
 *
 * @author Ben Gunter
 * @since Stripes 1.4.3
 */
