...
/**
 * Interface which must be implemented by classes which provide the ability to parse the POST
 * content when it is of type multipart/form-data. Provides a single, pluggable wrapper interface
 * around third party libraries which provide this capability.
 *
 * @author Tim Fennell
 * @since Stripes 1.4
 */
