...
/**
 * Exception that is thrown when the post size of a multipart/form post used for
...
public class FileUploadLimitExceededException extends StripesServletException {
    ...
    /**
     * Constructs a new exception that contains the limit that was violated, and
     * the size of the post that violated it, both in bytes.
     *
     ...
     *
     * @return The maximum size in bytes for HTTP POSTs.
     */
     ...
     *
     * @return the size in bytes of the HTTP POST.
     */
