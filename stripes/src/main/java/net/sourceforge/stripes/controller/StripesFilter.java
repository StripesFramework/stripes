...
public class StripesFilter implements Filter {
   ...
   public static Configuration getConfiguration() {
      ...
      if ( configuration == null ) {
         StripesRuntimeException sre = new StripesRuntimeException("Something is trying to access the current Stripes configuration but the "
    ...
    */
   protected static Configuration createConfiguration( FilterConfig filterConfig ) throws ServletException {
      ...
      Class<? extends Configuration> clazz = bootstrap.getClassProperty(CONFIG_CLASS, Configuration.class);
   ...
   public void doFilter( ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain ) throws IOException, ServletException {
      ...
      try {
         ...
         if ( initial ) {
            ...
            StripesFilter.configurationStash.set(configuration);
            ...
            StripesRequestWrapper.findStripesWrapper(httpRequest).pushUriParameters((HttpServletRequestWrapper)httpRequest);
         }
         ...
         configuration.getExceptionHandler().handle(t, httpRequest, httpResponse);
      }
      finally {
   ...
   public void init( FilterConfig filterConfig ) throws ServletException {
      ...
      StripesFilter.configurations.add(new WeakReference<>(configuration));
