 ...
 *
 * <ul>
 *   <li>Converting them to the rich type of the property on the target JavaBean
 *   <li>Setting the properties on the JavaBean using the appropriate mechanism
 * </ul>
 *
 ...
 * should be populated before returning.
 *
 * @author Tim Fennell
 */
public interface ActionBeanPropertyBinder extends ConfigurableComponent {
   ...
   * If additional properties exist in the request which are not present in the bean a message
   * should be logged, but binding should continue without throwing any errors.
   *
