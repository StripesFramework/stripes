 ...
 * contained in the HttpServletRequest and:
 * <ul>
 * <li>Converting them to the rich type of the property on the target
 * JavaBean</li>
 * <li>Setting the properties on the JavaBean using the appropriate
 * mechanism</li>
 * </ul>
 *
 * <p>
 * Implementations may also perform validations of the fields during binding. If
 * validation errors occur then the collection of ValidationErrors contained
 * within the ActionBeanContext should be populated before returning.</p>
 *
 * @author Tim Fennell
 */
public interface ActionBeanPropertyBinder extends ConfigurableComponent {
    ...
    /**
     * Populates all the properties in the request which have a matching
     * property in the target bean. If additional properties exist in the
     * request which are not present in the bean a message should be logged, but
     * binding should continue without throwing any errors.
     *
