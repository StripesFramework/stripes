...
/**
 * A subclass of {@link IllegalStateException} that is thrown when validation
 * errors are present on a request and the source page cannot be determined.
 *
 * @author Ben Gunter
 * @since Stripes 1.5.5
 */
public class SourcePageNotFoundException extends IllegalStateException
{
     ...
     * @return Action bean context for this exception
     */
