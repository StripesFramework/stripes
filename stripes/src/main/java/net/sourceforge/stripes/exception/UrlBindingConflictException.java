...
public class UrlBindingConflictException extends StripesRuntimeException {
   ...
   protected static String getMessage( Class<? extends ActionBean> targetClass, String path, Collection<String> matches ) {
      return (targetClass == null ? "" : "Failure generating URL for " + targetClass + ". ") + "The path " + path
            + " cannot be mapped to a single ActionBean because multiple " + "URL bindings match it. The matching URL bindings are " + matches + ". If you "
            ...
            + "If you generated the URL by some other means, then you must embed enough " + "information in the URL to achieve the same end.";
   }

   private final String                      _path;
   private final Collection<String>          _matches;
   private final Class<? extends ActionBean> _targetClass;
