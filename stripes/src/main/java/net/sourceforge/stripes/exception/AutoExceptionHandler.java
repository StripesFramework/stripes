 ...
 * </pre>
 *
 * <p>where <code>Type</code> can be any subclass of {@link java.lang.Throwable}. Handler methods do
 * not have to follow any naming convention. In the above example 'handle' is used, but any other
 * name, e.g. 'run', 'handleException' etc. would have worked as well. The return type is only
 * loosely enforced; if the method returns an object, and it is a {@link
