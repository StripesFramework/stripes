 ...
 * information and other information about the environment on which the jar is being executed.
 *
 * @author Tim Fennell
 * @since Stripes 1.1.1
 */
public class Main {
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("For more information on Stripes please visit https://stripesframework.org");
  }
}
