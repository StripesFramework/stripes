...
/**
 * Simple executable class that is used as the Main-Class in the Stripes jar.
 * Outputs version information and other information about the environment on
 * which the jar is being executed.
 *
 * @author Tim Fennell
 * @since Stripes 1.1.1
 */
public class Main {
     ...
     * @param argv - Necessary command line parameters for a main method.
     */
