...
/**
 * Specifies that the annotated method should be run <i>after</i> the specified {@link
 * LifecycleStage}(s). More than one LifecycleStage can be specified, in which case the method will
 * be run after each stage completes. If no LifecycleStage is specified then the default is to
 * execute the method after {@link LifecycleStage#EventHandling}. {@link LifecycleStage#RequestInit}
