...
/**
 * Type that is designed to be returned by &quot;handler&quot; methods in
 * ActionBeans. The Resolution is responsible for executing the next step after
 * the ActionBean has handled the user's request. In most cases this will likely
 * be to forward the user on to the next page.
 *
