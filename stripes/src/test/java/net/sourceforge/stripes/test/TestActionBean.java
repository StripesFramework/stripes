...
/**
 * An ActionBean that has a fairly complete/complex set of properties in order
 * to help out in binding tests.
 *
 * @author Tim Fennell
 */
...
public class TestActionBean implements ActionBean {
    ...
    /**
     * Pair of static classes used to check type finding via instances intead of
     * type inference.
     */
     ...
     */
    public List<TestBean> getListOfBeans() {
        return listOfBeans;
    }

    public void setListOfBeans(List<TestBean> listOfBeans) {
    ...
    public void setMapOfLongs(Map<String, Long> mapOfLongs) {
        this.mapOfLongs = mapOfLongs;
    }

    /**
     * A map of Objects which should get populated as Strings because String
     * extends Object.
     */
    public Map<String, Object> getMapOfObjects() {
        return mapOfObjects;
    }

    public void setMapOfObjects(Map<String, Object> mapOfObjects) {
    ...
    public void setSingleLong(Long singleLong) {
        this.singleLong = singleLong;
    }

    /**
     * A non-generic list to make sure specifying the converter is used
     * properly.
     */
    @SuppressWarnings("unchecked")
    @Validate(converter = LongTypeConverter.class)
    public List getNakedListOfLongs() {
        return nakedListOfLongs;
    }

    @SuppressWarnings("unchecked")
    public void setNakedListOfLongs(List nakedListOfLongs) {
        this.nakedListOfLongs = nakedListOfLongs;
    }
     ...
     */
    public void setSetOnlyString(String setOnlyString) {
        this.setOnlyString = setOnlyString;
    }

    public boolean setOnlyStringIsNotNull() {
        return this.setOnlyString != null;
    }

    /**
     * An array of enums to test out enums, and arrays of non-instantiable
     * things.
     */
     ...
     */
    public PropertyLess getItem() {
        return item;
    }

    public void setItem(PropertyLess item) {
        this.item = item;
    }
