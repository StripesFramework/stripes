...
/**
 * An ActionBean that has a fairly complete/complex set of properties in order to help out in
 * binding tests.
 *
 * @author Tim Fennell
 */
...
public class TestActionBean implements ActionBean {
  ...
  /**
   * Return type is a property-less class, but returns an instance of a subclass with an 'id'
   * property.
   */
