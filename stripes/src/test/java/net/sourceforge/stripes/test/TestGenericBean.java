...
/**
 * A JavaBean that is a generic type. Used to test some of the more gnarly aspects of binding into
 * beans with lots of generics going on. This is exercised in {@link
 * net.sourceforge.stripes.controller.GenericsBindingTests#testGenericBean()}.
 *
 * <p>The specifics of what is being tested is described in STS-427, which is now fixed.
 *
