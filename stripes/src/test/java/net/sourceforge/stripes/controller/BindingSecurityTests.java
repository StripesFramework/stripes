...
public class BindingSecurityTests extends FilterEnabledTestBase {
  ...
  @StrictBinding
  public static class DefaultAnnotation extends NoAnnotation {
    @Override
    public boolean[] getExpectSuccess() {
  ...
  public static class ImplicitDeny extends NoAnnotation {
    @Override
    public boolean[] getExpectSuccess() {
  ...
  public static class ExplicitDeny extends NoAnnotation {
    @Override
    public boolean[] getExpectSuccess() {
      return new boolean[] {true, true, false};
    }
  ...
  public static class ImplicitAllow extends NoAnnotation {
    @Override
    public boolean[] getExpectSuccess() {
      return new boolean[] {true, true, true};
    }
  ...
  @StrictBinding
  public static class HonorValidateAnnotations extends NoAnnotation {
    @Override
    public boolean[] getExpectSuccess() {
  ...
  @StrictBinding(deny = "**")
  public static class OverrideValidateAnnotations extends HonorValidateAnnotations {
    @Override
    public boolean[] getExpectSuccess() {
