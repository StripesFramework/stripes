...
/**
 * Basically a mirror of GenericsBindingTests except that in this case the type variable/ parameter
 * information is pushed further up the hierarchy. So this test ensures that our type inference
 * using type variables works when the information is not directly in this class, but further up the
 * hierarchy.
 *
 * @author Tim Fennell
 */
...
public class GenericsBindingTests2 extends Class4<TestBean, Double, Boolean, Long, Date>
