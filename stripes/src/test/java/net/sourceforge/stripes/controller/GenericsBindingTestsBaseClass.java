...
/**
 * A simple base class that is littered with Type parameters at the class level.
 * Contains no tests in and of itself, but it is necessary to be a public class
 * in order for {@link GenericsBindingTests} to extend it and have the methods
 * be accessible.
 *
 * @author Tim Fennell
 */
