...
public class UrlBindingFactoryTests {
  private abstract static class BaseActionBean implements ActionBean {
  ...
  public static void setupClass() {
    Class<? extends ActionBean>[] classes =
        new Class[] {
          ConflictActionBean1.class,
          ConflictActionBean2.class,
          ConflictActionBean3.class,
          ConflictActionBean4.class,
          FooActionBean.class,
          FooActionBean1.class,
          FooActionBean2.class,
          FooActionBean3.class,
          FooActionBean4.class,
          FooActionBean5.class,
          FooActionBean6.class,
          FooActionBean7.class,
  ...
  public void testParser1() {
    Class<? extends ActionBean>[] classes =
        new Class[] {
          BadSyntaxActionBean1.class,
          BadSyntaxActionBean2.class,
          BadSyntaxActionBean3.class,
          BadSyntaxActionBean4.class,
          BadSyntaxActionBean5.class,
          BadSyntaxActionBean6.class,
          BadSyntaxActionBean7.class,
          BadSyntaxActionBean8.class
        };

    for (Class<? extends ActionBean> clazz : classes) {
      net.sourceforge.stripes.action.UrlBinding annotation =
          clazz.getAnnotation(net.sourceforge.stripes.action.UrlBinding.class);
  ...
  public void testParser2() {
    Class<? extends ActionBean>[] classes =
        new Class[] {
          GoodSyntaxActionBean1.class,
          GoodSyntaxActionBean2.class,
          GoodSyntaxActionBean3.class,
          GoodSyntaxActionBean4.class,
          GoodSyntaxActionBean5.class,
          GoodSyntaxActionBean6.class,
          GoodSyntaxActionBean7.class,
          GoodSyntaxActionBean8.class,
          GoodSyntaxActionBean9.class,
          GoodSyntaxActionBean10.class,
  ...
  public void testUrlBindings() {
    ...
    checkBinding(
        "/foo/1/bar/2/", FooActionBean4.class); // #4 matches with more components than #6 or #3
  ...
  public void testConflictDetectionIndependentOfClassLoadingOrder() {
    ...
    factory.addBinding(
        FooActionBean2.class, UrlBindingFactory.parseUrlBinding(FooActionBean2.class));
    factory.addBinding(
        FooActionBean3.class, UrlBindingFactory.parseUrlBinding(FooActionBean3.class));
    factory.addBinding(
        FooActionBean4.class, UrlBindingFactory.parseUrlBinding(FooActionBean4.class));
    factory.addBinding(
        FooActionBean5.class, UrlBindingFactory.parseUrlBinding(FooActionBean5.class));
    factory.addBinding(
        FooActionBean6.class, UrlBindingFactory.parseUrlBinding(FooActionBean6.class));
    factory.addBinding(
        FooActionBean7.class, UrlBindingFactory.parseUrlBinding(FooActionBean7.class));
    factory.addBinding(
        FooActionBean8.class, UrlBindingFactory.parseUrlBinding(FooActionBean8.class));
    ...
    factory.addBinding(FooActionBean.class, UrlBindingFactory.parseUrlBinding(FooActionBean.class));
    factory.addBinding(
        FooActionBean2.class, UrlBindingFactory.parseUrlBinding(FooActionBean.class));
    try {
      factory.getBindingPrototype("/foo");
