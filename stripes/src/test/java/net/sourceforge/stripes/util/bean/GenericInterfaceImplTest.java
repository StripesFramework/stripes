 ...
 * specified in an interface using a type parameter. In this case the compiler
 * generates bridge method(s) that wrap the actual implementations of of the
 * interface methods, and have erased types! This test ensures that BeanUtil
 * does the right thing and finds the non-bridge method(s) and determines their
 * types.
 *
 * @author Tim Fennell
 */
public class GenericInterfaceImplTest extends FilterEnabledTestBase {
    ...
    /**
     * A simple implementation of a parameterized interface with a type
     * argument.
     */
