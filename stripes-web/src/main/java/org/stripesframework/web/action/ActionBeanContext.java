...
public class ActionBeanContext {
    ...
    * remove() or clear().</p>
    *
    * <p>Messages are stored in a {@link FlashScope} for
   ...
   public String getSourcePage() {
      String sourcePage = _request.getParameter(StripesConstants.URL_KEY_SOURCE_PAGE);
      if ( sourcePage != null ) {
   ...
   public String toString() {
      return getClass().getName() + "{" + "eventName='" + _eventName + "'" + ", validationErrors=" + _validationErrors + "}";
   }
}
