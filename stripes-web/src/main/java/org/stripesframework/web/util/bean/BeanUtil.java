...
public class BeanUtil {
    ...
    *         this bean
    */
   public static Object getPropertyValue( String expression, Object bean ) throws ParseException, EvaluationException {
    ...
    *         this bean
    */
   public static void setPropertyToNull( String expression, Object bean ) throws ParseException, EvaluationException {
    ...
    *         this bean
    */
   public static void setPropertyValue( String expression, Object bean, Object value ) throws ParseException, EvaluationException {
    ...
    *         this bean
    */
   private static PropertyExpressionEvaluation getEvaluation( String expression, Object bean ) throws ParseException, EvaluationException {
