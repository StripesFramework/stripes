...
public class ResolverUtil<T> {
    ...
    *        classes, e.g. {@code org.stripesframework.web}
    */
   ...
   public static class AnnotatedWith implements Test {
      ...
      public AnnotatedWith( Class<? extends Annotation> annotation ) { _annotation = annotation; }
   ...
   public static class IsA implements Test {
      ...
      public IsA( Class<?> parentType ) { _parent = parentType; }
