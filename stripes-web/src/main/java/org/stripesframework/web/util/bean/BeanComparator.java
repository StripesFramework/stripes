...
public class BeanComparator implements Comparator<Object> {
   ...
   private final PropertyExpression[] _expressions;
   ...
   public BeanComparator( Locale locale, String... properties ) {
       _locale = locale;
      _expressions = new PropertyExpression[properties.length];

      for ( int i = 0; i < properties.length; ++i ) {
         _expressions[i] = PropertyExpression.getExpression(properties[i]);
      }
   }
   ...
   public int compare( Object o1, Object o2 ) {
      ...
      for ( PropertyExpression expression : _expressions ) {
