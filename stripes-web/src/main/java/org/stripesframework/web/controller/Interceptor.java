 ...
 * {@link ConfigurableComponent} interface. If implemented,
 ...
 * {@link Configuration}.  To configure interceptors you can either
 * implement your own Configuration (probably by subclassing
 * {@link RuntimeConfiguration}), or more likely by listing out
 * the interceptors desired in the web.xml as specified in the documentation for
 * {@link RuntimeConfiguration#initInterceptors()}.</p>
 *
 * @author Tim Fennell
 * @since Stripes 1.3
 */
