...
public class HttpCacheInterceptor implements Interceptor {
   ...
   private final Map<CacheKey, HttpCache> _cache = new ConcurrentHashMap<>(128);
   ...
   protected HttpCache getAnnotation( Method method, Class<? extends ActionBean> beanClass ) {
      ...
      HttpCache annotation = _cache.get(cacheKey);
      if ( annotation != null ) {
      ...
      _cache.put(cacheKey, annotation);
      return annotation;
   }
   ...
   private static final class CacheKey {
      ...
      public CacheKey( Method method, Class<? extends ActionBean> beanClass ) {
         ...
         _hashCode = method.hashCode() * 37 + beanClass.hashCode();
      }

      @Override
      public boolean equals( Object obj ) {
         final CacheKey that = (CacheKey)obj;
         return _method.equals(that._method) && _beanClass.equals(that._beanClass);
      }
      ...
      public String toString() {
         return _beanClass.getName() + "." + _method.getName() + "()";
      }
   }
}
