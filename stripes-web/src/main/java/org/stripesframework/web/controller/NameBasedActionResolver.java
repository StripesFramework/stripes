 ...
 * methods that are annotated with {@link UrlBinding} and
 * {@link HandlesEvent} will retain the bindings specified in
...
public class NameBasedActionResolver extends AnnotatedClassActionResolver {
   ...
   /**
    * In addition to the {@link ActionBean} class simple name, also add aliases for
    ...
    * {@link NameBasedActionResolver#getBindingSuffix()}.</p>
    *
