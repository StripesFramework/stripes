...
public abstract class StripesTagSupport implements Tag {
    ...
    */
   private Map<String, Object> _previousAttributeValues;
   ...
   public void popPageContextAttributes() {
      for ( Map.Entry<String, Object> entry : _previousAttributeValues.entrySet() ) {
         if ( entry.getValue() == null ) {
            _pageContext.removeAttribute(entry.getKey());
         } else {
   ...
   public void pushPageContextAttributes( Map<String, Object> attributes ) {
      _previousAttributeValues = new HashMap<>();

      for ( Map.Entry<String, Object> entry : attributes.entrySet() ) {
         String name = entry.getKey();
         _previousAttributeValues.put(name, _pageContext.getAttribute(name));
         _pageContext.setAttribute(name, entry.getValue());
      }
   }
