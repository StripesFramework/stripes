...
public class LayoutContext {
   ...
   public void setComponentRenderPhase( boolean b ) { componentRenderPhase = b; }
   ...
   public String toString() {
      return "LayoutContext{" + "component names=" + components.keySet() + ", parameters=" + parameters + '}';
   }
   ...
   protected void doIncludeHack( PageContext pageContext, String relativeUrlPath ) throws ServletException, IOException {
      ...
      final HttpServletResponse response = new HttpServletResponseWrapper((HttpServletResponse)pageContext.getResponse()) {
      ...
      pageContext.getRequest().getRequestDispatcher(relativeUrlPath).include(pageContext.getRequest(), response);
   }
