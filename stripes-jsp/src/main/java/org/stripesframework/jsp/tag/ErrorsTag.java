   ...
   public int doEndTag() throws JspException {
      try {
         ...
         if ( _display && !_nestedErrorTagPresent ) {
            ...
            String header = getResource(bundle, "header", ValidationErrorReportResolution.DEFAULT_HEADER);
            String footer = getResource(bundle, "footer", ValidationErrorReportResolution.DEFAULT_FOOTER);
