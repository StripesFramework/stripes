...
public abstract class LinkTagSupport extends HtmlTagSupport implements ParameterizableTag {
   ...
   private Object  _beanclass;
   private String  _url;
   private String  _anchor;
   private boolean _addSourcePage = false;
   private Boolean _prependContext;
   ...
   public void addParameter( String name, Object valueOrValues ) {
      _parameters.put(name, valueOrValues);
   }
    ...
    */
   public Object getBeanclass() { return _beanclass; }
    ...
    */
   public boolean isAddSourcePage() { return _addSourcePage; }

   /** Get the flag that indicates if the application context should be included in the URL. */
   public Boolean isPrependContext() { return _prependContext; }

   /**
    * Set the flag that indicates if the _sourcePage parameter should be
    * appended to the URL.
    */
   public void setAddSourcePage( boolean addSourcePage ) { _addSourcePage = addSourcePage; }
    ...
    */
   public void setBeanclass( Object beanclass ) { _beanclass = beanclass; }
   ...
   public void setPrependContext( Boolean prependContext ) { _prependContext = prependContext; }
   ...
   protected String buildUrl() throws StripesJspException {
      ...
      UrlBuilder builder = new UrlBuilder(_pageContext.getRequest().getLocale(), base, false);
      if ( _event != VALUE_NOT_SET ) {
         builder.setEvent(_event == null || _event.length() < 1 ? null : _event);
      }
      if ( _addSourcePage ) {
         builder.addParameter(StripesConstants.URL_KEY_SOURCE_PAGE, CryptoUtil.encrypt(request.getServletPath()));
      }
      if ( _anchor != null ) {
      ...
      if ( contextPath.length() > 1 ) {
         boolean prepend =
               _prependContext != null && _prependContext || _prependContext == null && _beanclass != null || _prependContext == null && url.startsWith("/")
   ...
   protected String getPreferredBaseUrl() throws StripesJspException {
      ...
      if ( _beanclass != null ) {
         String beanHref = getActionBeanUrl(_beanclass);
         if ( beanHref == null ) {
            throw new StripesJspException(
                  "The value supplied for the 'beanclass' attribute " + "does not represent a valid ActionBean. The value supplied was '" + _beanclass
