...
/**
 * Manages the administration of People, from the Administer Bugzooky page. Receives a List of
 * People, which may include a new person and persists the changes. Also receives an Array of IDs
 * for people that are to be deleted, and deletes them.
 *
 * @author Tim Fennell
 */
