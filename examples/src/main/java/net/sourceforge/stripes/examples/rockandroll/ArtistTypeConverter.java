...
public class ArtistTypeConverter implements TypeConverter< Artist> {
    ...
    /**
     * Takes the passed identifier and tries to look up a corresponding Artist
    ...
    public Artist convert(String artistIdentifier,
        ...
        if (artist == null) {
            ...
            // If the artist is not found by the TypeConverter, then throw and error.
            if (artist == null) {
                errors.add(new SimpleError("Unable to find artist by identifier passed => " + artistIdentifier));
            }
        }
