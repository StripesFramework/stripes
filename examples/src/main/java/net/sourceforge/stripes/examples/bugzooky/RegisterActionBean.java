...
public class RegisterActionBean extends BugzookyActionBean {
  ...
  /**
   * Validates that the two passwords entered match each other, and that the username entered is not
   * already taken in the system.
   */
  @ValidationMethod
    ...
    getContext()
        ...
        .add(
            new LocalizableMessage(
                getClass().getName() + ".successMessage",
