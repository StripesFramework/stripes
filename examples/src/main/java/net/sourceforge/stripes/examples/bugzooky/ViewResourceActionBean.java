...
public class ViewResourceActionBean extends BugzookyActionBean {
  ...
  public void validate(ValidationErrors errors) {
    if (resource.startsWith("/WEB-INF") && !resource.startsWith("/WEB-INF/src")) {
      errors.add("resource", new SimpleError("Naughty, naughty. We mustn't hack the URL now."));
    }
  }
  ...
  /**
   * Method used when this ActionBean is used as a view helper. Returns a listing of all the JSPs
   * and ActionBeans available for viewing.
   */
