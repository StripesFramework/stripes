...
/**
 * Manages the administration of Components, from the Administer Bugzooky page. Receives a List of
 * Components, which may include a new component and persists the changes. Also receives an Array of
 * IDs for components that are to be deleted, and deletes those.
 *
 * @author Tim Fennell
 */
public class AdministerComponentsActionBean extends BugzookyActionBean {
  ...
  /**
   * If no list of components is set and we're not handling the "save" event then populate the list
   * of components and return it.
   */
