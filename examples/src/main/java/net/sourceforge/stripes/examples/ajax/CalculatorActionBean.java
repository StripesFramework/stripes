...
/**
 * A very simple calculator action that is designed to work with an ajax front end. Handles 'add'
 * and 'divide' events just like the non-ajax calculator. Each event calculates the result, and then
 * "streams" it back to the browser. Implements the ValidationErrorHandler interface to intercept
 * any validation errors, convert them to an HTML message and stream the back to the browser for
 * display.
 *
 * @author Tim Fennell
 */
