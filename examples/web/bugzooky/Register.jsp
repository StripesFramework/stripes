		...
		<stripes:form beanclass="${actionBean.class}" focus="">
			...
			<table class="leftRightForm">
				<tr>
					...
					<td><stripes:text name="user.firstName" /> <stripes:errors field="user.firstName" /></td>
				</tr>
				<tr>
					<th><stripes:label for="user.lastName" />:</th>
					<td><stripes:text name="user.lastName" /> <stripes:errors field="user.lastName" /></td>
				</tr>
				<tr>
					<th><stripes:label for="user.username" />:</th>
					<td><stripes:text name="user.username" /> <stripes:errors field="user.username" /></td>
				</tr>
			</table>

			<div class="buttons"><stripes:submit name="gotoStep2" value="Next" /></div>
		</stripes:form>
